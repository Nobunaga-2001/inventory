...
const Adminboard = () => {
  ...
  const chartOptions = {
    responsive: false, // Not responsive as per your requirement
    ...
    plugins: {
      legend: {
        display: chartType === 'pie', // Only display legend for pie chart
        position: 'top', // Adjust legend position for better visualization
      },
      tooltip: {
        enabled: true, // Enable tooltips for user interactivity
        callbacks: {
    ...
    datasets: [
      {
        label: 'Monthly Sales',
        data: monthlySales,
        backgroundColor: colors.slice(0, monthlySales.length), // Apply dynamic colors
        borderColor: 'rgba(54, 162, 235, 1)', // Adjust border color
        borderWidth: 1, // Thicker borders for better visualization
      },
    ],
  };
            ...
            <div className={styles.right}>
              ...
              <div className={styles.rightR}>
                <div className={styles.chart}>
                  {chartType === 'line' ? (
                    <Line ref={chartRef} data={chartData} options={chartOptions} height={300} width={600} />
                  ) : chartType === 'bar' ? (
                    <Bar ref={chartRef} data={chartData} options={chartOptions} height={300} width={600} />
                  ) : (
                    <Pie ref={chartRef} data={chartData} options={chartOptions} height={300} width={600} />
                  )}
                </div>
              </div>
            </div>
